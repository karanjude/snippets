...
namespace MyTetris
{
    ...
    {
        public ZBlock(GameField gameField,Texture2D backgroundTexture, Vector2 origin,Direction direction)
            : base(gameField,
        ...
        private void rotateEastWest()
        {
            ...
            square4.Position = Vector2.Add(square2.Position, new Vector2(-backgroundTexture.Width, backgroundTexture.Height));
